...
namespace ScalesManager.Component
{
    ...
    {
        MaHoaPass maHoaPass = new MaHoaPass();
        #region Constructor
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if (cmbAuthentication.SelectedIndex == 0)
                ...
                XML.XMLWriter("Connection.xml", maHoaPass.Encrypt(txtServer.Text, true) , maHoaPass.Encrypt(txtUsername.Text, true) ,maHoaPass.Encrypt(txtPassword.Text,true), maHoaPass.Encrypt(cmbDatabase.Text, true), "false");
